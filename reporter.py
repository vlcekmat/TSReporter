...
def report_bug(project, log_lines, version, images_folder_path, assign, username, password):
    ...
    while True:
        try:
            if not tried_duplicates:
                duplicate_found = check_for_duplicates(log_first, username, password)
            ...
            if not duplicate_found:
                ...
                upload_to_mantis(
                    ...
                    assign, project, username, password, True
                )
            else:
    ...
    #        try:
    #            upload_to_mantis(
    #                version, images_folder_path, category, log_lines,
    #                assign, project, username, password, True
    #            )
    #            break
    #        except SessionNotCreatedException:
